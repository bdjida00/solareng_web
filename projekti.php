...
<head>
    ...
    <title>Naši projekti – Solar Engineering d.o.o</title>
    <meta name="description" content="Pogledajte odrađene projekte solarnih elektrana tvrtke Solar Engineering d.o.o.">
    ...
    <style>
        .page-hero {
            background: linear-gradient(135deg, #0f2f59 0%, #164480 100%);
            color: white;
            padding: 60px 20px;
            text-align: center;
        }
        .page-hero h1 { font-weight: 800; font-size: clamp(1.8rem, 4vw, 2.6rem); margin-bottom: 12px; }
        ...
        .project-card .thumb { height: 220px; object-fit: cover; width: 100%; }
        .project-card .thumb-placeholder { height: 220px; background: #e9ecef; display: flex; align-items: center; justify-content: center; color: #adb5bd; font-size: 3rem; }
        .project-card .body { padding: 20px; flex-grow: 1; display: flex; flex-direction: column; }
        .project-card .naslov { font-size: 1.05rem; font-weight: 700; color: #164480; margin-bottom: 6px; }
        .project-card .lokacija { font-size: 0.85rem; color: #6c757d; margin-bottom: 12px; }
        .project-card .specs { margin-top: auto; display: flex; flex-wrap: wrap; gap: 6px; }
        .spec-badge { background: #eef2f8; color: #164480; font-size: 0.78rem; font-weight: 600; border-radius: 20px; padding: 3px 10px; }
...
<body>
    ...
    <div class="page-hero">
        <h1>Naši projekti</h1>
        <p>Pogledajte odabrane realizirane projekte solarnih elektrana koje smo projektirali i ugradili.</p>
    </div>
    ...
    <div class="container my-5">
        <?php if (empty($projekti)): ?>
            <div class="empty-state">
                <i class="bi bi-sun d-block"></i>
                <p class="mb-0">Projekti uskoro…</p>
            </div>
        <?php else: ?>
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <a href="projekt.php?id=<?= $p['id'] ?>" class="project-card">
                    ...
                    <div class="body">
                        ...
                        <?php if ($p['opis']): ?>
                            <p style="font-size:.88rem;color:#6c757d;line-height:1.5;margin-bottom:12px;">
                                <?= htmlspecialchars(mb_substr($p['opis'], 0, 100)) ?><?= mb_strlen($p['opis']) > 100 ? '…' : '' ?>
                            </p>
                        <?php endif; ?>
                        <div class="specs">
                            <?php if ($p['snaga_kw']): ?>
